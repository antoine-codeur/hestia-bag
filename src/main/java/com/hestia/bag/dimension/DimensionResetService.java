...
public final class DimensionResetService {
    ...
    public void reset(UUID ownerUuid) {
        ...
        plugin.getLogger().info("Home of {} has been reset.", ownerUuid);
    }
    ...
    private DimensionContentSnapshot takeSnapshot(PlayerHome home) {
        plugin.getLogger().info("[TODO] Snapshot dimension contents for {}.", home.ownerUuid());
    ...
    private void applyDrops(DimensionContentSnapshot snapshot, DropTarget target) {
        switch (target) {
            case DropTarget.AtPosition at ->
                    ...
                    plugin.getLogger().info("[TODO] Spawn {} drops at {}.", snapshot.size(), at.position());
            ...
            case DropTarget.Pending ignored ->
                    ...
                    plugin.getLogger().info("[TODO] Stash {} drops as pending recovery.", snapshot.size());
        }
    }
    ...
    private void wipeDimensionContent(PlayerHome home) {
        ...
        plugin.getLogger().info("[TODO] Wipe dimension contents for {}.", home.ownerUuid());
    }
